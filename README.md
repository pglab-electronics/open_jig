...
Note: The holes in the PCB support body must be large enough to avoid any friction or contact with either the pogo pins or the alignment pins.

<img width=768 alt="JIG with PCB" src="https://github.com/pglab-electronics/open_jig_test/blob/main/img/jig_with_pcb.png" />

On the top side of the jig, add four PCB pushers positioned according to your PCB geometry. These pushers must apply a uniform downward pressure on the PCB to ensure stable contact with all pogo pins during testing.
